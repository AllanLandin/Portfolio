...
export default function Hero() {
  return (
    <Fade delay={100} duration={1500} direction="down">
      <article className="flex flex-col items-center gap-7 text-3xl my-9">
        ...
        <div className="flex gap-2">
          <Link
            href="/"
            className="p-3 border border-emphasis rounded text-emphasis font-poppins hover:bg-emphasis hover:text-secondary"
          >
            Trabalhe comigo
          </Link>
          <Link
